    ...
    <div class="tab-content active" id="home">
        <form action="" class="problemSignal" method="post">
            <input id="" type="text" name="address"
                   value="<?php if (isset($_SESSION['user'])): ?><?php echo $_SESSION['user']['address']; ?> <?php endif; ?>"
                   placeholder="Adresse" class="namadress"/><br>
            <input id="" type="email" name="email"
                   value="<?php if (isset($_SESSION['user'])): ?><?php echo $_SESSION['user']['email']; ?> <?php endif; ?>"
    ...
    <div class="tab-content" id="mentions">
        <form action="" class="contact" method="post">
            <input id="first_name" type="text" name="firstName"
                   value="<?php if (isset($_SESSION['user'])): ?><?php echo $_SESSION['user']['firstname']; ?> <?php endif; ?>"
                   placeholder="Votre nom" class="namadress"/><br>
