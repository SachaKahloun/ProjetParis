        ...
        <section class="col-9">
            ...
            <form action="new_form.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control"  type="text" placeholder="Titre" name="title" id="title"><?php if (isset($_GET['new_id'])) echo $infoNew['title'] ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control"  type="text" placeholder="Résumé" name="summary" id="summary"><?php if (isset($_GET['new_id'])) echo $infoNew['summary'] ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control"  type="text" placeholder="Contenu" name="content" id="content"><?php if (isset($_GET['new_id'])) echo $infoNew['content'] ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control"  type="date" placeholder="" name="publish_at" id="publish_at" value="<?php if (isset($_GET['new_id'])) echo $infoNew['publish_at'] ?>"/>
