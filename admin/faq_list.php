            ...
            <table class="table table-striped">
                ...
                <?php foreach ($faqs as $key => $faq) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="faq_form.php?faq_questions_id=<?php echo $faq['id']; ?>&action=edit" class="btn btn-warning">Modifier</a>
                            <a onclick="return confirm('Are you sure?')" href="faq_list.php?faq_questions_id=<?php echo $faq['id']; ?>&action=delete" class="btn btn-danger">Supprimer</a>
                        </td>
                    </tr>
