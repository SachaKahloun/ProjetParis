...
<section class="secondInformation">
    ...
    <h4>Adresse: <?php echo $_SESSION ['user']['address']. ' ' . $_SESSION ['user']['zip_code'] .' '. $_SESSION ['user']['city'];?></h4>
</section>
</section>
...
<section class="firstBills">
    <section class="secondBills">
        ...
        <section class="thirdBills">
            ...
            <button class="toView"><a href="./assets/pdf/<?= $bill['image']; ?>.pdf" target="_blank">Visualiser</a> </button>
        </section>
        <?php endforeach; ?>
    </section>
</section>
